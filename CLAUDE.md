...
- **Status:** Phase 2 — Analytics (slices 1 + 2 complete: yield_over_time + failure_pareto + individuals_chart (SPC/XmR) + z_score_anomalies; BUG-007 fully closed; slice 3 — Streamlit dashboard — next)
...
| 2 — Analytics | SPC, Pareto, anomaly detection, dashboard v1 | 🟡 In progress (slice 1 of ~3 complete) |
